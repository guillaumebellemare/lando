<a href="<?=URL_ROOT.$lang2.'/'.$routes['cart']; ?>" class="cart-counter-wrapper"><?=$cart["cart"]?><?php if(isset($_SESSION['cart']) && count($_SESSION['cart']['items'])): ?>
...
<ul>
    <li>
        ...
        <div class="cart-quickview">
            ...
            <a href="<?=URL_ROOT.$lang2.'/'.$routes['cart']; ?>" class="btn is-full-width has-no-margin"><?=$cart["see_cart"]?></a>
        </div>
        <?php endif; ?>
    </li>
</ul>
