...
class paypal_class {
   ...
   var $waiting_message = '';
   var $click_label = 'Cliquez ici pour aller directement au module de paiement PayPal';
   var $f_class_name = 'fPayment';
   ...
   function submit_paypal_post($lang2='fr') {
 	  global $lang2;
      ...
      $pp_post .= "<form method=\"post\" name=\"paypal_form\" class='$this->f_class_name' ";
      $pp_post .= "action=\"".$this->paypal_url."\">\n";

      foreach ($this->fields as $name => $value) {
         $pp_post .= "<input type=\"hidden\" name=\"$name\" value=\"$value\"/>\n";
      }
